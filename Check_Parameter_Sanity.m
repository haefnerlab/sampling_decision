...
if ~any(strcmpi(P.I.stimulus_regime, {'blank', 'static'})) ...
        && P.I.n_zero_signal >= P.I.n_frames
    error('n_zero_signal >= n_frames. Nothing left to be signal!');
end
if any(strcmpi(P.I.stimulus_regime, {'dynamic-delayed', 'dynamic-switching-signal','dynamic-switching-signal-blocked'})) ...
