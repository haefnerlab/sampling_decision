function [ models_tuning ] = Orientation_Tuning_Like( e, signal, n_orient, trials )
...
for i=1:numel(e)
    model = e{i};
    models_tuning{i} = Orientation_Tuning_Response(model.Projection, model.Sampling, signal, n_orient, trials);
end
