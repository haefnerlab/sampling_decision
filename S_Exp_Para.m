...
switch mode
  case 'paper-2AFC-corr'
    ...
    P.G.kappa_G=3;
    P.G.delta=0.08; % strength of X-G coupling for corr & CPs
  ...
  case 'paper-2AFC-PK'
    ...
    P.G.kappa_O=[1 0]; % attended and unattended
    P.G.kappa_G=3;
    P.G.delta=0.08; % strength of X-G coupling
  ...
  case 'paper-corr-performance'
    ...
    P.G.kappa_O=[1 0]; % attended and unattended
    P.G.kappa_G=3;
    P.G.delta=0.08; % strength of X-G coupling for corr & CPs, 80/1024
    P.I.stimulus_regime='static';
    P.I.stimulus_contrast=zeros(1,P.number_orientations);
    P.S.number_repetitions=1024; % number of trials
    P.I.n_zero_signal=20; % number of frames before onset of stimulus
    P.S.number_burn_in=0; % number of burn-in samPles
    P.S.number_samples_to_use=100; %Number  of non-burn samples to be used for evidence
    P.S.number_samples_per_evidence=5; % for dynamic-switching-signal-blocked
    P.S.phi_O=[[0:2:2*(P.number_orientations-1)];[1:2:2*P.number_orientations-1]]*pi/2/P.number_orientations;
    P.S.pO=ones(1,P.number_orientations)/P.number_orientations;
    P.S.pL=ones(1,P.number_locations)/P.number_locations;
    P.S.tauStyle=0.1; % initial value for style
    P.S.sigmaStyle=0.1;
    P.S.odds_inc=1/20; % with 80 samples/sec, every 250ms independent signal
    P.S.nT = 2; % Number of possible tasks
